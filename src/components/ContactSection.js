...
//   { Icon:HiOutlinePhone,            label:"Phone",    value:"012345982211"  },
...
//           transition={{duration:.6,delay:.1}} className="font-display tracking-[.2em] uppercase text-p4 text-center mb-3"
...
//                 className="px-4 py-3.5 rounded-xl font-mono text-sm text-[#e8e0d4] placeholder-p3/60 bg-p1/40 border border-p4/15 focus:outline-none focus:border-p4/45 transition-colors duration-300"/>
...
//               className="px-4 py-3.5 rounded-xl font-mono text-sm text-[#e8e0d4] placeholder-p3/60 bg-p1/40 border border-p4/15 focus:outline-none focus:border-p4/45 transition-colors duration-300"/>
//             <textarea rows={6} placeholder="Your Message" value={form.message}
//               onChange={e=>setForm({...form,message:e.target.value})} required
//               className="px-4 py-3.5 rounded-xl font-mono text-sm text-[#e8e0d4] placeholder-p3/60 bg-p1/40 border border-p4/15 focus:outline-none focus:border-p4/45 transition-colors duration-300 resize-none"/>
//             <MagneticButton className="self-start">
//               <button type="submit"
//                 className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-mono text-[.68rem] tracking-[.2em] uppercase font-bold text-darker transition-all duration-300"
//                 style={{background:sent?"#40534C":"linear-gradient(135deg,#677D6A,#D6BD98)",boxShadow:"0 4px 28px rgba(214,189,152,.28)"}}>
//                 {sent ? "✓ Sent!" : (<>Open Message <HiArrowRight/></>)}
//               </button>
//             </MagneticButton>
//           </motion.form>
...
//               Have a project in mind or want to say hi? Feel free to reach out at any time. I usually respond within 24 hours.
//             </p>
...
const INFO = [
  { Icon: HiOutlineMail,           label: "Email",    value: "asad@example.com"  },
  { Icon: HiOutlinePhone,          label: "Phone",    value: "+92 300 123 4567" },
  { Icon: HiOutlineLocationMarker, label: "Location", value: "Pakistan"          },
]
