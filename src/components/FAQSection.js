...
function FAQItem({ item, open, onHover }) {
  return (
    <div
      onMouseEnter={onHover}
      className={`rounded-xl overflow-hidden border transition-all duration-300 cursor-default ${
        open ? "border-p4/30 bg-p1/60" : "border-p4/10 bg-p1/20"
      }`}
    >
      <div className="w-full flex items-center justify-between px-6 py-5 text-left gap-4">
